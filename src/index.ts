...
import leadStandardPropertyRouter from "./routes/lead-standard-property";
import leadStatusRouter from "./routes/lead-status";
...
app.use("/lead-standard-property", authMiddleware, leadStandardPropertyRouter);
